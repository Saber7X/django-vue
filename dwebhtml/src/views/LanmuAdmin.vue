      ...
      <el-row :gutter="10">
        <el-col :span="8">
          ...
          <div class="body dweb" style="display:flex">
            ...
            <el-button @click="pushLanmuList()" type="success">成功按钮</el-button>
          </div>
          <div class="body dweb">
            <el-tree
                :data="lanmu_tree"
          ...
          <div class="save-tree body dweb" style="float:left">
            <el-button @click="getLanmuTree()" type="waring" size="mini">恢复结构</el-button>
                ...
                <el-row>
                  ...
                  <el-col class="text-item" :xs="12" :lg="7">
                    ...
                    >
                      ...
                      <el-button type="warning" icon="el-icon-plus" circle slot="reference"></el-button>
                      <el-button type="success" size="mini" @click="saveArticleToLanmu(item.id)">确定</el-button>
                    </el-popover>
                  </el-col>
                </el-row>
              </div>
...
export default {
  ...
  mounted() {
    this.getListData(this.currentPage,this)
    this.getLanmuTree()
  },
  methods: {
    //选择栏目查看文章
    ...
    // 选择文章保存栏目
    choosed_lanmu(node, data) {
      console.log(node, data)
      this.choosed_article_id = node.id
    ...
    pushLanmuList() {
      ...
      this.loopCheckData(this.lanmu_tree)
